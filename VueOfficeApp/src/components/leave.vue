	                                ...
	                                <div class="item-content">
	                                    <div class="item-inner">
	                                        ...
	                                        <div class="item-input">
	                                            ...
	                                            <template>
												    <el-date-picker v-model="value1" format="yyyy/MM/dd" id='val' type="date" placeholder="选择开始日期" :picker-options="pickerOptions0">
												    </el-date-picker>
												</template>
	                                        </div>
	                                    </div>
	                                    ...
	                                    <div class="item-inner">
	                                        ...
	                                        <div class="item-input">
	                                            <!-- <input type="text" placeholder="请选择结束时间" id="end-time-picker" class="date-picker"> -->
	                                             <template>
												    <el-date-picker v-model="value2" format="yyyy/MM/dd" id='val' type="date" placeholder="选择结束日期" :picker-options="pickerOptions0">
												    </el-date-picker>
												</template>
	                                        </div>
	                                    </div>
	                                    ...
	                                    <div class="item-inner">
	                                        ...
	                                        <el-switch
	                                         :change='switchChange()'
											  ...
											  on-text=''
											  off-text=''>
											</el-switch><span class="label_checkbox-hint">不带薪</span>
...
function submitOvertimeApply(title, reason, startTime, endTime, hours, have_salary, msg) {
	...
	$('#btn-submit').click(function() {
	    ...
	    var hours = $('#hours').val();
	    var isChecked=vueThis.value3;
	    // var isChecked = $("#salary-checkbox").attr('checked');
	    var have_salary;
	    console.log(type + '+' +reason+'+'+startTime+'+'+endTime+'+'+ hours+'+'+ isChecked)
	    if(isChecked) {
	        have_salary = 1;
	        // $.toast('带薪');
	        vueThis.$message('带薪')
